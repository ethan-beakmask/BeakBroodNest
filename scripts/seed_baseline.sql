...
INSERT INTO nav_menu (id, name, url, icon, sort_order, is_active, created_at) VALUES (7, '行事曆', '/beakbroodnest/calendar', 'bi-calendar3', 18, true, '2026-05-01 00:00:00.000000') ON CONFLICT DO NOTHING;
INSERT INTO nav_menu (id, name, url, icon, sort_order, is_active, created_at) VALUES (9, '待辦', '/beakbroodnest/todos', 'bi-check2-square', 19, true, '2026-05-17 00:00:00.000000') ON CONFLICT DO NOTHING;
