...
![](docs/images/hero-whiteboard-gallery.png)

![](docs/images/canvas-CardEdit.png)

![](docs/images/wbs-gantt.png)
...
![](docs/images/Observe-Reviews.png)
...
- **AI 介面**（MCP Server）：30+ MCP tools，Claude 等 AI 直接讀寫
...
```bash
# 開發模式（hot reload）
python human_ui/app.py --serve --port 5170 --host 0.0.0.0

# 正式模式（gunicorn）
gunicorn --bind 127.0.0.1:5171 --workers 2 human_ui.app:app
```

啟動後瀏覽 http://localhost:5170/
...
![](docs/images/Observe-TalkList.png)
...
![](docs/images/peer-level_actor_system.png)
