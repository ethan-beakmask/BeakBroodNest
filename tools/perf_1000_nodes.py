...
用法:
  python tools/perf_1000_nodes.py create   建立測試白板
  python tools/perf_1000_nodes.py delete   清除測試資料

註：功能是 perf_nodes.py 的固定 1000 節點特例，等價於
`python tools/perf_nodes.py create 1000`。
"""
import sys, math, os
